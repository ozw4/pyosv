...
1. API skeleton.
   Add an opt-in reference-like scanner path without changing
   `FaultOrientScanner3.scan()` defaults. Define shape, dtype, angle sampling,
   and output contracts first.
