...
def build_experiment(context: CompactSourceContext) -> Mapping[str, object]:
    ...
    return {
        ...
        "visualization": {
            ...
            "attribute_display_threshold_ratio_by_stage": dict(
                ATTRIBUTE_DISPLAY_THRESHOLD_RATIO_BY_STAGE
            ),
            ...
            "attribute_halo_stages": sorted(ATTRIBUTE_HALO_STAGES),
            "fvt_halo_enabled": FVT_HALO_ENABLED,
            "fvt_halo_radius_pixels": FVT_HALO_RADIUS_PIXELS,
            "fvt_halo_alpha": FVT_HALO_ALPHA,
            "fvt_halo_structure": FVT_HALO_STRUCTURE,
            "fvt_halo_color": FVT_HALO_COLOR,
